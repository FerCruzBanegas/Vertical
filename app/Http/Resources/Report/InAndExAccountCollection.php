...
class InAndExAccountCollection extends ResourceCollection
{
    private $account;
    private $init;
    private $end;
    ...
    public function __construct($collection, $params)
    {
        ...
        $this->init = Carbon::parse($params[1][0])->format('d/m/Y'); 
        $this->end = Carbon::parse($params[1][1])->format('d/m/Y');    
    }
    ...
    public function toArray($request)
    {
        return [
            ...
            'options' => [
                'grid' => [
                    'title' => "Movimientos De la cuenta: {$this->account} ({$this->init} - {$this->end})",
                    'type' => "flat",
                    'showGrandTotals' => "on"
                ]
            ],
