            ...
            <v-layout>
              <v-flex xs12 sm12 md12 lg12 xl12>
                <v-card>
                  <v-card-title>
                    <v-btn
                      v-if="permission('expense-types.create')"
                  ...
                  >
                    ...
                    <template slot="items" slot-scope="props">
                      <td class="justify-center layout px-0">
                        <v-btn v-if="permission('expense-types.show')" icon class="mx-0" @click="getDetail(props.item.id)">
                      ...
                      <td>
                        <v-btn
                          v-if="permission('expense-types.update')"
                          small 
                          flat 
                          icon class="mx-0" 
                          color="grey"
                        ...
                        <v-btn 
                          v-if="permission('expense-types.destroy')"
                          small
                          flat 
                          icon class="mx-0" 
                          color="red"
